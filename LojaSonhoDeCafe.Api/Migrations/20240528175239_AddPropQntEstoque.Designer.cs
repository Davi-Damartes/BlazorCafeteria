...
namespace LojaSonhoDeCafe.Api.Migrations
{
    ...
    [Migration("20240528175239_AddPropQntEstoque")]
    partial class AddPropQntEstoque
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LojaSonhoDeCafe.Models.Entity.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f416ba15-10bc-4ba6-a457-fa608d024caa"),
                            NomeUsuario = "David"
                        },
                        new
                        {
                            Id = new Guid("d148975c-35b4-43ea-9dd2-91269cabc9a6"),
                            NomeUsuario = "Adm"
                        });
                });
